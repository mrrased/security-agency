...
const HeaderTop = () => {
    ...
    return (
        <div className={`${color ? 'bg-[#f2f3f7] py-5 transition_custom transition duration-700 z-20 fixed overflow-hidden top-0' : 'bg-none'} bg-[#f2f3f7] top-0 py-10 fixed transition_custom transition duration-900 overflow-hidden w-full`}>
