        ...
        <Container maxWidth='lg' className='mt-40'>
            ...
            <div
                ...
                <div
                    ...
                    <div
                        className="relative backface_visibility float-left -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                        data-te-carousel-active
                    ...
                    <div
                        ...
                        {/* <img
                            ...
                            <div className='block w-full bg-[#f2f3f7] h-[36rem] md:h-[29rem]'></div>
                        <div
                            className="absolute inset-x-[15%]  bottom-[5.25rem] py-5 text-center text-white ">
                            <img src={img2} alt="" className='rounded-full w-[160px] h-[160px] mx-auto' />
                            <p className='font-normal text-[#6c758f] Bellota_Text text-sm md:text-[1.2rem] text-center mb-4 mt-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus eu laoreet odio. Aenean eget lorem pellentesque, imperdiet ex convallis, iaculis justo. Etiam ac purus purus. Vivamus vel lacus non diam gravida efficitur. Proin elementum velit vel mauris euismod consectetur. Nunc neque libero, pulvinar et odio eu, vestibulum iaculis tortor.</p>
                            <h5 className="text-xl text-[#36187d]">Jonh Manson</h5>
                        </div>
                    </div>
                    <div
                        className="relative backface_visibility float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                        ...
                        <div
                            ...
                            <p className='font-normal text-[#6c758f] Bellota_Text text-sm md:text-[1.2rem] text-center mb-4 mt-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus eu laoreet odio. Aenean eget lorem pellentesque, imperdiet ex convallis, iaculis justo. Etiam ac purus purus. Vivamus vel lacus non diam gravida efficitur. Proin elementum velit vel mauris euismod consectetur. Nunc neque libero, pulvinar et odio eu, vestibulum iaculis tortor.</p>
                            <h5 className="text-xl text-[#36187d]">Alexa Brown</h5>
                        </div>
                    </div>
                </div>
                <button
