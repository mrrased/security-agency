    ...
    return (
        <Container maxWidth="lg" className='mt-40'>
            <div className='lg:flex items-center justify-around'>
                <div>
                <h3 className='font-normal text-[#36187d] Bellota_Text text-[2.4rem] text-left'>Follow Us</h3>
                <p className='font-normal text-[#6c758f] Bellota_Text text-[1.2rem] text-left w-[35rem]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus eu laoreet odio. Aenean eget lorem pellentesque, imperdiet ex convallis, iaculis justo.</p>
                </div>
